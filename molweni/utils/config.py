...
parser.add_argument(
    "--model_name_or_path",
    default='/SISDC_GPFS/Home_SE/hy-suda/pre-train_model/electra-large/',
    type=str,
    # required=True,
...
parser.add_argument('--PLM_layer_idx', nargs='*', help='<Required> Set flag', default=[2, 4, 6])
parser.add_argument('--warmup_proportion', type=float, default=0.01)

# parser.add_argument('--fgm', type=bool, default=False)
# parser.add_argument('--grdrop', type=bool, default=False)
# parser.add_argument('--rdrop', type=bool, default=True)
# parser.add_argument('--grdrop', type=bool, default=True)
...
parser.add_argument('--MAX_UTTERANCE_INNER_NODE_NUM', type=int, default=110)
parser.add_argument('--MAX_UTTERANCE_NUM', type=int, default=16)
parser.add_argument('--MAX_QUESTION_INNER_NODE_NUM', type=int, default=6)
parser.add_argument('--MAX_SPEAKER_NUM', type=int, default=10)
parser.add_argument('--b', type=float, default=0.1)
parser.add_argument('--flood', action="store_true")

parser.add_argument('--first_freeze_then_finetune', action="store_true")
parser.add_argument('--freeze_steps', type=int, default=1400)
parser.add_argument('--num_gat_layers', type=int, default=2)
parser.add_argument('--inner_graph_layers', type=int, default=2)
parser.add_argument('--query_discourse_layers', type=int, default=2)
parser.add_argument('--num_gat_heads', type=int, default=8)
parser.add_argument('--device_id', type=int, default=0)
parser.add_argument('--parallel', action="store_true")
parser.add_argument('--gnn', type=str, default="HGT")
parser.add_argument('--ques_type', type=str, default="what")
...
parser.add_argument('--spk_num_mode', type=int, default=1)
